window.QUIZ_DATA = {
  ...
  "results": {
    "hunter": {
      ...
      "share_text": "みんなが騒ぐ頃には興味を失っている孤高の存在。\nNVDAが爆上げ中に黙って高配当株を買っていた。"
    },
    "kunren": {
      "name": "慎重カメ",
      "emoji": "🐢",
    ...
    "sns": {
      ...
      "share_text": "乗り遅れ恐怖が王位に就いた。天井命中率：名人。\n最高値更新のニュースを見てエントリーする。"
    },
    "topbuyer": {
      "name": "天井スナイパー",
      "emoji": "🏔️",
    ...
    "god": {
      ...
      "share_text": "2021年以降だけで7回天井を命中させた伝説。\n安値で買うという概念が脳に存在しない。"
    }
  }
};
