window.QUIZ_DATA = {
  ...
  "results": {
    "legend": {
      ...
      "share_text": "配当金だけで旅行代を払う不労所得の完成形。\n株価より配当通知が楽しみな生き方。"
    },
    "seiri": {
      "name": "FIRE仙人",
      "emoji": "🏔️",
      ...
      "share_text": "退職後も毎日株価を見ている。退職後の方が働いていた。\nFIREしたのに相場から離れられない謎の自由人。"
    },
    "restart": {
      "name": "億り人",
      "emoji": "💰",
    ...
    "kaifuku": {
      ...
      "share_text": "一番多い末路。NISAと定期預金を両方使う正しい投資家。\n「銀行よりはマシ」が口癖の地味に賢い人。"
    },
    "mushoku": {
      "name": "投資ジャンキー",
      "emoji": "🎰",
      ...
      "share_text": "土日が嫌いで月曜を待ち続ける相場中毒者。\n祝日に仮想通貨市場を発見して問題を解決した。"
    },
    "saikin": {
      "name": "含み損仙人",
      "emoji": "🧘",
    ...
    "haisan": {
      ...
      "share_text": "利益確定だけは上手い。その後の取引で利益を消す。\n利益100万円・最終資産マイナスを達成した伝説の存在。"
    }
  }
};
