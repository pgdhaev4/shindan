window.QUIZ_DATA = {
  ...
  "results": {
    "philosopher": {
      ...
      "share_text": "感情ゼロ・計画100%・暴落でも昼寝できる存在。\n投資トークが盛り上がらないのが唯一の欠点。"
    },
    "analyst": {
      "name": "分析マシーン",
      "emoji": "📊",
      ...
      "share_text": "PER、PBR、決算資料を全部読む分析の鬼。\n分析が多すぎて買えない状態に陥ることがある。"
    },
    "strategist": {
      "name": "未来予想士",
      "emoji": "♟️",
    ...
    "survivor": {
      ...
      "share_text": "少し下がると即売り。強気相場でも半額しか入れない。\n保有中も不安で頭がいっぱいの繊細な存在。"
    },
    "healer": {
      "name": "欲張りタヌキ",
      "emoji": "🦝",
      ...
      "share_text": "+50%を見て待ち続けた結果マイナスで終わる。\n「もっと上がる」という欲望に毎回負ける。"
    },
    "addict": {
      "name": "暴落ゴリラ",
      "emoji": "🦍",
    ...
    "chaos": {
      ...
      "share_text": "1日で投資方針が3回変わる究極の感情型。\n「もう投資やめる」の発言を今年17回確認されている。"
    }
  }
};
