window.QUIZ_DATA = {
  ...
  "results": {
    ...
    "akuryo": {
      ...
      "share_text": "売るという概念が存在しない鋼の男。\nテンバガーを元の株価まで戻した伝説の保有者。"
    },
    "gambler": {
      "name": "決算ギャンブラー",
      "emoji": "🎲",
    ...
    "lever": {
      ...
      "share_text": "2倍では満足しない。3倍でも物足りない。\n刺激がなければ投資ではない。"
    },
    "gorilla": {
      "name": "暴落買いゴリラ",
      "emoji": "🦍",
