window.QUIZ_DATA = {
  ...
  "results": {
    "saint": {
      ...
      "share_text": "一番儲かるのに一番話題にならない。絶滅危惧種。\nクズ要素がなさすぎて診断が成立しないレベル。"
    },
    "good": {
      "name": "優柔不断ナマケモノ",
      "emoji": "🦥",
      ...
      "share_text": "検討力だけが伸び続けている。去年の候補をまだ検討中。\n「もう少し考える」は永遠に終わらない。"
    },
    "grey": {
      "name": "利確早漏マン",
      "emoji": "😅",
      ...
      "share_text": "+3%で勝者の顔をする。売った翌日にストップ高が来る。\nテンバガーを+10%で手放す才能。"
    },
    "dangerous": {
      "name": "損切り不能兵",
      "emoji": "⚔️",
      ...
      "share_text": "部隊は全滅したが、本人だけ残留している。\n「まだ負けてない」は売ったら確定するだけ。"
    },
    "kuzu_level1": {
      "name": "ナンピン将軍",
      "emoji": "📣",
      ...
      "share_text": "下がるほど自信が増す逆説の将軍。\nチャンスが多すぎて資金が消えた。現金ゼロで祈っている。"
    },
    "kuzu_level2": {
      "name": "FOMO猿",
      "emoji": "🐒",
      ...
      "share_text": "タイムラインに脳を支配される。高値掴み率：天才。\n買った瞬間インフルエンサーが利確する。"
    },
    "kuzu_level3": {
      "name": "レバレッジ特攻隊長",
      "emoji": "🔥",
      ...
      "share_text": "普通の投資では脳が反応しない。退場経験：豊富。\n人生は変わった。悪い方向に。"
    },
    "god_kuzu": {
      "name": "爆損の錬金術師",
      "emoji": "👿",
      ...
      "share_text": "3回退場したのに4回復活している。資産曲線がジェットコースター。\n反省会を開催しても毎回同じことをする。"
    }
  }
};
